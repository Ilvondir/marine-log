...
class Container_b997916141 extends _PHPStan_02959ca10\Nette\DI\Container
{
	protected $tags = [
		...
		return new PHPStan\Analyser\Ignore\IgnoredErrorHelper(
			...
			[
				[
					...
					'count' => 3,
					'path' => '/var/www/html/app/Contracts/Repositories/ObservationRepositoryInterface.php',
				],
				[
				...
				[
					...
					'identifier' => 'generics.lessTypes',
					'count' => 1,
					'path' => '/var/www/html/app/Contracts/Repositories/UserRepositoryInterface.php',
				],
				[
				...
				[
					...
					'count' => 1,
					'path' => '/var/www/html/app/Http/Requests/UpdateObservationRequest.php',
				],
				[
					'message' => '#^Class App\\\Models\\\Resource referenced with incorrect case\: App\\\Models\\\resource\.$#',
					'identifier' => 'class.nameCase',
					'count' => 3,
					'path' => '/var/www/html/app/Models/Observation.php',
				],
				[
				...
				[
					...
					'count' => 1,
					'path' => '/var/www/html/app/Models/Role.php',
				],
				[
					'message' => '#^Generic type Illuminate\\\Contracts\\\Pagination\\\LengthAwarePaginator\<App\\\Models\\\Observation\> in PHPDoc tag @return does not specify all template types of interface Illuminate\\\Contracts\\\Pagination\\\LengthAwarePaginator\: TKey, TValue$#',
					'identifier' => 'generics.lessTypes',
					'count' => 3,
					'path' => '/var/www/html/app/Repositories/EloquentObservationRepository.php',
				],
				[
				...
				[
					...
					'identifier' => 'generics.lessTypes',
					'count' => 1,
					'path' => '/var/www/html/app/Repositories/EloquentUserRepository.php',
				],
				[
				...
				[
					...
					'identifier' => 'generics.lessTypes',
					'count' => 3,
					'path' => '/var/www/html/app/Services/ObservationService.php',
				],
				[
					'message' => '#^Type App\\\Models\\\Observation in generic type Illuminate\\\Contracts\\\Pagination\\\LengthAwarePaginator\<App\\\Models\\\Observation\> in PHPDoc tag @return is not subtype of template type TKey of \(int\|string\) of interface Illuminate\\\Contracts\\\Pagination\\\LengthAwarePaginator\.$#',
					'identifier' => 'generics.notSubtype',
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_b997916141 $container)
			{
	...
	public function createServiceContainer(): Container_b997916141
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'MAIL_FROM_NAME' => 'MarineLog',
				'DB_DATABASE' => 'marine_log',
				'SESSION_PATH' => '/',
				'APP_NAME' => 'MarineLog',
				'SESSION_DRIVER' => 'database',
				'VITE_APP_NAME' => 'MarineLog',
				'SHELL_VERBOSITY' => '0',
				'LOG_CHANNEL' => 'stack',
				'DB_USERNAME' => 'sail',
				...
				'MAIL_PORT' => '2525',
				'APP_ENV' => 'local',
				'APP_KEY' => 'base64:d0hmRt4e4TTHHnxhYQ2opOAqzxl2Xs3cB6l99kwpiTY=',
				...
				'IGNITION_LOCAL_SITES_PATH' => '/home/user/10x-project',
				'APP_LOCALE' => 'en',
