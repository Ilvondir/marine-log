...
class Container_1d2ebd4e98 extends _PHPStan_02959ca10\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_1d2ebd4e98 $container)
			{
	...
	public function createServiceContainer(): Container_1d2ebd4e98
	{
		return $this;
	}
