...
class Container_c652b483fb extends _PHPStan_02959ca10\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_c652b483fb $container)
			{
	...
	public function createServiceContainer(): Container_c652b483fb
	{
		return $this;
	}
